...
def load_model():
    ...
    model = RagTokenForGeneration.from_pretrained(
        "facebook/rag-token-nq",
        retriever=retriever,
        trust_remote_code=True, # Added trust_remote_code=True here as well, though might not be strictly necessary for the model itself, but for consistency and potential related loading steps
    )
