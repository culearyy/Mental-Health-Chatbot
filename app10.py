...
# ---------------------------------------------------
# 6. UI Setup with Styled Chat Bubbles
# ---------------------------------------------------
...
# Use a key for your text input so we can clear it by resetting session state
...
if user_input:
    ...
    # Clear the text input by resetting the session state key
    st.session_state["user_message"] = ""

# Helpful resources at the bottom
st.markdown("---")
